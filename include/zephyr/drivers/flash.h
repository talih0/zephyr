...
#define FLASH_EX_OP_MARK_BAD_BLOCK             BIT(1)
#define FLASH_EX_OP_IS_PAGE_ERASED             BIT(2)
#define FLASH_EX_OP_IS_PARTIAL_PAGE_ERASED     BIT(3)
#define FLASH_EX_OP_INTERNAL_MOVE_PARTIAL_PAGE BIT(4)
#define FLASH_EX_OP_GET_PARTIAL_PAGE_SIZE      BIT(5)
